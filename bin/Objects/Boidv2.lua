...
function Boid:new(orderedUpdate,x,y,opts)
  ...
  self.y = y
  self.w = 5
  self.shape = {self.x,self.y+boidSize, self.x-boidSize/2,self.y-boidSize,self.x,self.y,self.x+boidSize/2,self.y-boidSize}
  self.collider = orderedUpdate.physicsWorld:newPolygonCollider(self.shape)
