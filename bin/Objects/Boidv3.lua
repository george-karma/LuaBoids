...
function Boid:new(orderedUpdate,x,y,opts)
  ...
  self.velocity = Vector:new(self.currentVelocity*math.cos(self.rotation),self.currentVelocity*math.sin(self.rotation))
...
function Boid:update(dt)
  ...
  if self.collider then 
    ...
    self.x,self.y = self.collider:getPosition() 
    self.collider:setLinearVelocity(self.velocity:unpack(),self.velocity:unpack()[2])
	end
end
